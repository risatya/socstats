                            ...
                            <li id="myAccordion" class="accordion">
                                ...
                                <div class="accordion-body collapse <?php echo ($active == '#collapseStats') ? 'active' : ''; ?> in" id="collapseStats">
                                    <ul>
                                        ...
                                        <li class="<?php echo ($active == 'rekapox') ? 'active' : ''; ?>" style="list-style: none"><?php echo anchor('administrator/rekapox?order=team', 'Statistic O/X', 'title="Statistic O/X"'); ?></li>
                                    </ul>
                                </div>
                                ...
                                <div class="accordion-body collapse <?php echo ($active == '#collapseStats') ? 'active' : ''; ?> in" id="collapseSummary">
                                    <ul>
                                        ...
                                        <li class="<?php echo ($active == 'summaryox') ? 'active' : ''; ?>" style="list-style: none"><?php echo anchor('administrator/summaryox/0', 'Summary O/X', 'title="Summary O/X"'); ?></li>
                                    </ul>
                                </div>
                                ...
                                <div class="accordion-body collapse <?php echo ($active == '#collapseStats') ? 'active' : ''; ?> in" id="collapseHistory">
                                    <ul>
                                        ...
                                        <li class="<?php echo ($active == 'historyox') ? 'active' : ''; ?>" style="list-style: none"><?php echo anchor('administrator/historyox', 'History O/X', 'title="History O/X"'); ?></li>
                                    </ul>
                                </div>
                            </li>
