...
<div><a style="float: left" href="<?php echo base_url('index.php/administrator/summaryou/'.($this->uri->segment(3)-1));?>">Prev</a> <a style="float: right" href="<?php echo base_url('index.php/administrator/summaryou/'.($this->uri->segment(3)+1));?>">Next</a></div>
<hr/>
