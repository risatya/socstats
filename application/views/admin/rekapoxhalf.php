...
?>
<legend>
	STATISTIC X/O Half-time
</legend>
<div class="tabbable">
    <form method="POST" action="<?php echo base_url('index.php/administrator/pilihrekapox'); ?>">
		...
		$('#mySelect').change(function(){ 
	    	...
	    	window.location = "<?php echo base_url().'index.php/administrator/rekapox/'?>"+$(this).val()+"?order=team";
		});
		</script>
	</form>
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th>No</th>
                <th><a href="<?php echo base_url('index.php/administrator/rekapox/'.$this->uri->segment(3).'?order=team');?>">Team</a></th>
