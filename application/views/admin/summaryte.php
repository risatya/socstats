...
$('#mySelect').change(function() {
	window.location = "<?php echo base_url() . 'index.php/administrator/summaryte/' . $this->uri->segment(3) . '?f=' ?>" + $(this).val();
});
</script>
<div><a style="float: left" href="<?php echo base_url('index.php/administrator/summaryte/' . ($this->uri->segment(3) - 1)); ?>">Prev</a> <a style="float: right" href="<?php echo base_url('index.php/administrator/summaryte/' . ($this->uri->segment(3) + 1)); ?>">Next</a></div>
<hr/>
