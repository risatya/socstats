...
//}
    ...
    function  negarabyidteam($idteam){
...
//        print_r($data);
//        exit();
        $data['id_competition'] = $this->idcompbyname($data['id_competition'], $data['link_competition'], $data['kepanjangan']);
        return $data;
    }
