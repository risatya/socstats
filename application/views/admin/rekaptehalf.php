...
?>
<legend>
	Statistic T/E Half-time
</legend>
<div class="tabbable">

    <form method="POST" action="<?php echo base_url('index.php/administrator/pilihrekapte'); ?>">
      ...
      $('#mySelect').change(function(){ 
          ...
          window.location = "<?php echo base_url().'index.php/administrator/rekapte/'?>"+$(this).val()+"?order=team";
      });
      </script>
  ...
  <table class="table table-bordered table-hover">
    <thead>
        <tr>
            <th>No</th>
            <th><a href="<?php echo base_url('index.php/administrator/rekapte/'.$this->uri->segment(3).'?order=team');?>">Team</a></th>
        </tr>
    </thead>
