    ...
    <form method="POST" action="<?php echo base_url('index.php/administrator/pilihlistteam'); ?>">
        ...
        <script>
            $('#mySelect').change(function() {
                ...
                window.location = "<?php echo base_url() . 'index.php/administrator/historyox/' ?>" + $(this).val() + "?order=team";
            });
        </script>
    </form>
        ...
        <table class="table table-bordered" id="data">
            <thead>
                <tr>
                    ...
                    <th style="" class="span1"><a href="<?php echo base_url('index.php/administrator/historyox/' . $this->uri->segment(3) . '?order=negara'); ?>">Team</a></th>
                    <?php 
                    for ($i=2;$i<=14;$i++)
