/*
 * ======================================================== bootstrap-table.js
 * v0.4 https://github.com/frejnorling/bootstrap-table
 * ======================================================== Copyright 2013 Frej
 * Norling.
 * 
...
!function($) {
	...
	Table.prototype = {
		...
		show : function() {
			...
			var $this = this.element, $content = $this.attr('data-content'), $type = $this
					.attr('data-type'), $title = $this.attr('title')
			...
			function open() {
				...
				if (type === "modal") {
					...
					if ($(element).hasClass("table-toggle")) {
						...
						var tr = "<tr><td colspan='" + cols + "'>" + content
								+ "</td></tr>";
	...
	$(function() {
		$('body')
				.on(
						'click.table.data-api',
						'[data-type="modal"], [data-type="inline"], [data-url="*"], [data-content="*"]',
						function(e) {
							e.preventDefault();
							$(this).table('show')
						})
